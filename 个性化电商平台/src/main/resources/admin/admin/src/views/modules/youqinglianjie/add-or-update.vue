	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="链接网址" prop="lianjiewangzhi">
					<el-input v-model="ruleForm.lianjiewangzhi" placeholder="链接网址" clearable  :readonly="ro.lianjiewangzhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="链接网址" prop="lianjiewangzhi">
